class Shape3DViewer {
    ...
    initCuttingPlaneTransform() {
        ...
        // 对象变化时更新切割平面
        this.cuttingPlaneTransform.addEventListener('objectChange', () => {
            this.updateCuttingPlaneFromTransform();
        });
    ...
    enableCuttingPlaneTransform() {
        ...
        // 重置代理对象旋转
        this.cuttingPlaneProxy.rotation.set(0, 0, 0);
    }
    ...
    setCuttingPlaneTransformMode(mode) {
        ...
        if (mode === 'translate') {
            // 移动模式：更新切割平面位置
            this.cuttingPlaneTransform.addEventListener('objectChange', () => {
                this.updateCuttingPlanePositionFromTransform();
            });
        } else if (mode === 'rotate') {
            // 旋转模式：更新切割平面法向量
            this.cuttingPlaneTransform.addEventListener('objectChange', () => {
    ...
    updateShapesList() {
        ...
        if (list) {
            ...
            this.shapes.forEach((mesh, id) => {
                ...
                const rainbowButton = item.querySelectorAll('button')[0];
